...
$titlePage = "แสดงรายการสั่งซื้อสินค้า";


// แสดงรายการสินค้าที่มีสถานะ "รอตรวจสอบ" (order_status = 'รอตรวจสอบ')
try {
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title mr-1">ข้อมูลรายการสั่งซื้อสินค้ารอตรวจสอบ</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <?php if (count($result)) { ?>
                                            ...
                                            <tbody>
                                                <?php foreach ($result as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form method="post" action="order_edit_form.php">
