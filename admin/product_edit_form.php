                                ...
                                <div class="card card-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class=" form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="prd_name" placeholder="กรุณากรอก ชื่อสินค้า" value="<?php echo $result["prd_name"] ?>">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="prd_price">ราคา : </label><span class="text-danger">*</span>
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="prd_price" placeholder="กรุณากรอก ราคาสินค้า เช่น 190, 145.55" value="<?php echo $result["prd_price"] ?>">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="prd_detail" rows="4" placeholder="กรุณากรอก รายบะเอียดสินค้า"><?php echo $result["prd_detail"] ?></textarea>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input custom-control-input-success" type="radio" id="show" name="prd_show" value="1" <?php if ($result["prd_show"] == "1") echo "checked"; ?>>
                                                <label for="show" class="custom-control-label">แสดงสินค้า</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <!-- หากการแสดงสินค่ามีค่า = 0 หรือ มีค่าไม่ใช่เลข 1 ให้ checked  -->
                                                <input class="custom-control-input custom-control-input-danger" type="radio" id="hide" name="prd_show" value="0" <?php if ($result["prd_show"] == "0" || $result["prd_show"] != "1") echo "checked"; ?>>
                                ...
                                <div class="card card-warning pb-5">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <label class="form-label" for="prd_img"> รูปภาพสินค้าใหม่ : </label>
                                            <input class="form-control" type="file" name="prd_newImg" id="prd_newImg" onchange="previewImage();">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
            ...
            $('#form').validate({
                ...
                messages: {
                    prd_name: {
                        ...
                        maxlength: "ต้องไม่เกิน 10 ตัวอักษร"
                    },
                    prd_price: {
                    ...
                    prd_detail: {
                        required: "กรุณากรอก รายละเอียดสินค้า"
                    },
                    pty_id: {
                        required: "กรุณาเลือก ประเภทสินค้า"
                    },
                    prd_newImg: {
